CREATE OR REPLACE PROCEDURE testdataset.sp_curated_layer_data_load()
BEGIN
...
USING (
		...
		from `testdataset.branch` Where branch_id is not null )
		where rn=1
	  ) S	
